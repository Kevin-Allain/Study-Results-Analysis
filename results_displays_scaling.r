...
genDF_distractor_correctB_dMask_focus <- function (d_h,d_n){
...
genAndPlotTrust_scaling_mask <- function(d_scl0,d_scl1,d_scl2) {
...
genAndPlotTrust_scaling_mask(d_scl0,d_scl1,d_scl2)
